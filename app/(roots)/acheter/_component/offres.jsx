...
export default function Offres() {
    return (
        <div className="w-4/6 mx-auto mt-20 mb-40">
            <div className="flex gap-7 items-center my-10">
                <h1 className="text-5xl font-extrabold">Offre en cash</h1>
            ...
            <div className="text-center shadow-xl">
                <div className="flex justify-between">
                    <div className="w-1/3">
                        ...
                        <p className="p-4">Définition de l&apos;offre</p>
                    </div>
                    <div className="w-1/3">
                        <h1 className="py-2 bg-[#ffe8c4] font-extrabold">Terrain 20/20</h1>
                        <div className="p-4">
                            <p>Terrains regroupés par lots avec voie d&apos;accès facile, bornés, viables et sécurisés</p>
                            <p>Dimensions: 400 Mètres carrés</p>
                        </div>
                    </div>
                    <div className="w-1/3">
                        ...
                        <div className="p-4">
                            <p>Terrains regroupés par lots avec voie d&apos;accès facile, bornés, viables et sécurisés</p>
                            <p>Dimensions: 500 Mètres carrés</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p className="w-5/6 p-6 mx-auto">Une formule qui, outre le fait de vous mettre à l&apos;abris d&apos;un eventuel oubli d&apos;épargner sur votre achat.
