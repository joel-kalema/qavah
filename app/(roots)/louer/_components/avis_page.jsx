...
export default function AvisPage() {
    return (
        <div className=" mx-auto relative lg:flex px-4 lg:px-0 my-20">
            <div className="overflow-hidden relative h-[70vh] lg:w-4/6 rounded-r-3xl mt-20">
                <Image src="/avis.jpg" layout="fill" objectFit="cover" alt="bay" quality={100} />
            </div>

        <div className="lg:w-3/6 py-10 px-4 lg:px-14 glass lg:absolute right-20 bottom-40">
