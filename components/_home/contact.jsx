            ...
            <div className="">
                <div className="h-[100vh] w-6/6 overflow-hidden relative rounded-xl">
                    ...
                    <div className="absolute left-40 top-10">
                        ...
                        <div className="bg-[#dedede9a] backdrop-blur-md rounded-2xl py-8 px-6 shadow-xl ml-6 w-3/4  relative z-20">
                        ...
                        <div className="bg-[#ffffff6d] backdrop-blur-xl rounded-2xl py-8 px-6 shadow-xl -mt-2 ml-12 w-3/4">
                            ...
                            <Button variant="outlined">+243 979 797 979</Button>
                        </div>
                    </div>
                </div>
            </div>
