...
export default function Questions() {
  ...
  return (
    <div className="w-5/6 mx-auto my-40 bg-[#efefef] flex gap-10 px-10 py-12 rounded-2xl">
      <div className="w-4/6">
        <h1 className="font-extrabold text-4xl">Questions Fréquemment Posées</h1>
        <p className="mt-10 mb-4 text-sm w-4/5">Vous avez choisi d&apos;acheter un bien neuf pour y habiter ou investir ; 
